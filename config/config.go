...
type ApiKeyEntry struct {
	...
	// BoundAccounts restricts this key to a specific set of Kiro account IDs.
	// When non-empty, requests authenticated with this key are routed ONLY to
	// these accounts, and these accounts become "exclusive": they are never
	// used by other keys or by unauthenticated/unbound requests. When empty,
	// the key may use any shared (non-exclusive) account.
